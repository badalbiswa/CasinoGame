...
int Game::blackJack() {
  ...
  std::cout
      << "Blackjack (21) is a battle against the dealer to reach 21 without going over. Cards are worth their face value, face cards are 10, and Aces are 1 or 11. You get two face-up cards, the dealer gets one face-up and one face-down. Hit for more cards, stand to stay. Don't bust (go over 21)! After you stand, the dealer reveals their hidden card and hits until they reach 17 or more. Whoever is closest to 21 without busting wins. Getting an Ace and a 10-value card on the first deal is Blackjack, an instant win!"
      << std::endl;
